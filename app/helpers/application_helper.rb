module ApplicationHelper
  ...
  def nav_link_active_class(variant = 'DESKTOP')
    case variant
    when 'DESKTOP'
      'inline-flex items-center px-1 pt-1 border-b-2 border-primary-600 text-sm leading-5 text-blue-200 focus:outline-none focus:border-blue-200 transition duration-150 ease-in-out ml-4 text-center font-bold'
    when 'MOBILE'
  ...
  def nav_link_inactive_class(variant = 'DESKTOP')
    case variant
    when 'DESKTOP'
      'inline-flex items-center px-1 pt-1 border-b-2 border-transparent text-sm leading-5 text-white hover:text-blue-200 hover:border-blue-200 focus:outline-none focus:text-blue-200 focus:border-blue-200 transition duration-150 ease-in-out ml-4 text-center'
    when 'MOBILE'
